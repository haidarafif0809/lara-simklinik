...
class KasMasukController extends Controller
{
    ...
    public function store(Request $request)
    {
        //
         ...
         TransaksiKas::create(['no_faktur' => $no_faktur,'jenis_transaksi'=>'kas_masuk' ,'tipe_transaksi' => 1,'jumlah' => $request->jumlah,'kas' => $request->kas] );
    ...
    public function update(Request $request, $id)
    {
        ...
        TransaksiKas::where('no_faktur' , $kas_masuk->no_faktur)->update(['jumlah' => $request->jumlah,'kas' => $request->kas] );
